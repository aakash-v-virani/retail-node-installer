...
To make use of **Windows Profile** certain prerequisites need to be met. For more details please [see this](#https://github.com/aakash-v-virani/rni-profile-base-windows/blob/main/docs/01_Prerequisites.md).
